    ...
    <div className=" px-6 py-12  sm:rounded-lg sm:px-12">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div>
          <button
            type="submit"
            className="cursor-pointer flex w-30 justify-center rounded-full bg-red-400 px-3 py-2 text-sm/6 font-semibold text-white shadow-xs hover:bg-red-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600"
          >
            Get Started
          </button>
        </div>
