  ...
  return (
    <div className=" px-6 py-12  sm:rounded-lg sm:px-12">
      <form action="#" method="POST" className="space-y-6">
        ...
        <p className=" text-sm">
          Choose your path with a free 7-day trail -no strings , cancel anytime 
        </p>
        ...
        <div className="w-1/2 space-y-4 mx-4 bg-gray-200 rounded-lg p-4">
          Your card
          <div className="bg-white p-4 rounded-lg">
            ...
            <Image
                ...
                unoptimized
              />
              <span className="rounded-full border border-red-400 text-red-400 px-2 text-xs items-center justify-center">7-day Free trial</span>
            </div>
        ...
        <div>
          <button
            type="submit"
            className="cursor-pointer flex w-30 justify-center rounded-full bg-red-500 px-3 py-2 text-sm/6 font-semibold text-white shadow-xs hover:bg-red-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600"
          >
            Subscribe
          </button>
        </div>
