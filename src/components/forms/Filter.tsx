...
export default function Filter() {
  ...
  return (
    <div className="sm:flex-auto">
      <div className="relative w-full flex  border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-red-300 focus:border-red-300">
        ...
        />
        <div
          className="flex items-center justify-center  px-3 w-30 text-red-400 gap-2 item cursor-pointer"
