...
export default function Toggle() {
  ...
  return (
    <Switch
      checked={enabled}
      onChange={setEnabled}
      className="group relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent bg-gray-200 transition-colors duration-200 ease-in-out focus:ring-2 focus:ring-red-600 focus:ring-offset-2 focus:outline-hidden data-checked:bg-red-600"
    >
      ...
      <span className="pointer-events-none relative inline-block size-5 transform rounded-full bg-white shadow-sm ring-0 transition duration-200 ease-in-out group-data-checked:translate-x-5">
        ...
        >
          <svg fill="currentColor" viewBox="0 0 12 12" className="size-3 text-red-600">
