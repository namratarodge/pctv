    ...
    <>
      <div className="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          If you wish to upgrade to a premium account, you must sign up first, then select the appropriate options via the settings/pricing page. Please get in touch with us for more info at pctv@projectcontrolstv.com
          </p>
        </div>
          ...
          <div className="bg-gray-100 px-6 py-12 shadow-sm sm:rounded-lg sm:px-12">
            <form onSubmit={handleSubmit}   className="space-y-6">
              ...
              <div>
                <button
                  type="submit"
                  className="flex w-full justify-center rounded-md bg-[#b13d37] px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-red-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600"
                >
                  LOGIN 
                </button>
              </div>
