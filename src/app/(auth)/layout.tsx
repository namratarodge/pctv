...
const navigation = [
  ...
  { name: "Tv Topics", href: "#", current: false },
  { name: "Course / Zone", href: "#", current: false },
              ...
              <div className="flex h-16 items-center justify-between">
                ...
                <div className="hidden md:block ">
                  <div className="ml-4 flex items-center md:ml-6">
                    ...
                    <div className="flex items-center  border-b border-b-white text-white overflow-hidden w-100">
                      <input
                        type="text"
                    ...
                    <Link href="register">
                    <button className="px-2 py-1 ml-4 bg-[#b13d37] rounded-sm text-md text-white cursor-pointer" >
                      SIGN UP
                    </button>
                    </Link>
                    <Link href="login">
                    <button className="px-2 py-1 ml-4  rounded-sm text-md text-white cursor-pointer">
                      LOGIN
                    </button>
                    </Link>
                  </div>
