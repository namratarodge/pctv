    ...
    <div className="pt-18 flex  max-w-7xl mx-auto">
      <div className="w-2/3 ">
        ...
        <h1 className="text-xl text-white py-4">
          Human-AI collaboration: Next generation connected technology Human-AI
          collaboration: Next generation connected technology
        </h1>
        ...
        <div className="flex justify-between py-2 border-t mt-4 border-b border-[#37454D]  mr-5">
          <p className="text-gray-400 text-sm">2024-09-11 12:30 PM</p>
          <div className="flex gap-2">
        ...
        <div className="py-4">
          <p className="text-gray-400">
            With a well-known industry average of only 2% of projects coming in
            on time, on budget and to the satisfaction of all stakeholders,[1]
            it’s no secret that ensuring project confidence within the capital
            construction industry remains challenging. Add in a global pandemic,
            and the stakes climb even higher, playing out in added risks t
          </p>
        </div>
